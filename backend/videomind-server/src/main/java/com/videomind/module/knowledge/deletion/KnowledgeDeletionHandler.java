...
public class KnowledgeDeletionHandler implements ProcessingTaskHandler {
    private final PhysicalDeletionCoordinator coordinator;

    @Override
    public ProcessingTaskType type() {
        return ProcessingTaskType.KNOWLEDGE_DELETE;
    }

    @Override
    public String handle(TaskExecutionContext context) throws Exception {
        return coordinator.deleteKnowledge(context);
    }
}
